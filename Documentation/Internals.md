...
- Methods:
  - [NEW] `Spellcheck:IsWordBlocked(word, locale, ignoreManual) → boolean`: Convenience function for checking a single word (e.g., during YALLM learning). ([`../Src/Spellcheck.lua#L540`](../Src/Spellcheck.lua#L540))
  - [NEW] `Spellcheck:GetBlockData(locale) → table|nil addedSet`: Returns the data needed to check if a word is blocked at runtime. ([`../Src/Spellcheck.lua#L521`](../Src/Spellcheck.lua#L521))
  ...
  - `Spellcheck:TouchUserDict(dict) → nil` ([`../Src/Spellcheck.lua#L481`](../Src/Spellcheck.lua#L481))
  - `Spellcheck:BuildWordSet(list) → table` ([`../Src/Spellcheck.lua#L488`](../Src/Spellcheck.lua#L488))
  - `Spellcheck:GetUserSets(locale) → table, table` ([`../Src/Spellcheck.lua#L502`](../Src/Spellcheck.lua#L502))
  - `Spellcheck:AddUserWord(locale, word) → nil` ([`../Src/Spellcheck.lua#L560`](../Src/Spellcheck.lua#L560))
  ...
  - Accessors: `GetMinWordLength` ([`../Src/Spellcheck.lua#L637`](`../Src/Spellcheck.lua#L637`))
  - Accessors: `GetUnderlineStyle` ([`../Src/Spellcheck.lua#L642`](`../Src/Spellcheck.lua#L642`))
  - Accessors: `GetKeyboardLayout` ([`../Src/Spellcheck.lua#L650`](`../Src/Spellcheck.lua#L650`))
  - Accessors: `GetKBDistTable` ([`../Src/Spellcheck.lua#L660`](`../Src/Spellcheck.lua#L660`))
  - Accessors: `_GetKBDistFromLayouts` ([`../Src/Spellcheck.lua#L679`](`../Src/Spellcheck.lua#L679`))
- Callbacks fired:
...
- Methods:
  - `CompareVersions` — Compares semantic version strings. ([`../Src/Interface/Window.lua#L291`](../Src/Interface/Window.lua#L291))
  - `GetSortedVersions` — Returns WHATS_NEW entries sorted by version. ([`../Src/Interface/Window.lua#L302`](../Src/Interface/Window.lua#L302))
  - `CheckForChangelogUpdate` — Handshake that updates seen records and triggers popups. ([`../Src/Interface/Window.lua#L378`](../Src/Interface/Window.lua#L378))
  - `PopulateWhatsNewContent` — Renders changelog notes into a container. ([`../Src/Interface/Window.lua#L814`](../Src/Interface/Window.lua#L814))
  - `RefreshWhatsNewContent` — Wipes and re-renders the WhatsNew popup. ([`../Src/Interface/Window.lua#L862`](../Src/Interface/Window.lua#L862))
  - `UpdateWhatsNewButtonScale` — Scales the 'Got it' button text. ([`../Src/Interface/Window.lua#L879`](../Src/Interface/Window.lua#L879))
  - [NEW] `Interface:GetWelcomeVersion() → number`: Returns the target version of the welcome screen content. ([`../Src/Interface/Window.lua#L313`](../Src/Interface/Window.lua#L313))
  ...
  - `ShouldShowWelcomeChoice` ([`../Src/Interface/Window.lua#L357`](`../Src/Interface/Window.lua#L357`))
  - `ShouldShowWhatsNew` ([`../Src/Interface/Window.lua#L369`](`../Src/Interface/Window.lua#L369`))
  - `MarkWelcomeShown` ([`../Src/Interface/Window.lua#L404`](`../Src/Interface/Window.lua#L404`))
  - `MarkVersionSeen` ([`../Src/Interface/Window.lua#L408`](`../Src/Interface/Window.lua#L408`))
  - `CreateWelcomeChoiceFrame` ([`../Src/Interface/Window.lua#L463`](`../Src/Interface/Window.lua#L463`))
  - `CreateWhatsNewFrame` ([`../Src/Interface/Window.lua#L657`](`../Src/Interface/Window.lua#L657`))
  - `CreateMainWindow` ([`../Src/Interface/Window.lua#L897`](`../Src/Interface/Window.lua#L897`))
  - `UpdateSidebarSelection` ([`../Src/Interface/Window.lua#L1082`](`../Src/Interface/Window.lua#L1082`))
  - `GetUIFontOffset` ([`../Src/Interface/Window.lua#L1101`](`../Src/Interface/Window.lua#L1101`))
  - `SetUIFontOffset` ([`../Src/Interface/Window.lua#L1107`](`../Src/Interface/Window.lua#L1107`))
  - `ScaledRow` ([`../Src/Interface/Window.lua#L1115`](`../Src/Interface/Window.lua#L1115`))
  - `ApplyUIFontScale` ([`../Src/Interface/Window.lua#L1121`](`../Src/Interface/Window.lua#L1121`))
  - `RefreshFontScaleLabel` ([`../Src/Interface/Window.lua#L1149`](`../Src/Interface/Window.lua#L1149`))
