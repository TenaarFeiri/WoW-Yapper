...
- Methods:
  - `Queue:IsAcceptableAck() → nil`: Check if a received chat event is an acceptable acknowledgement for an expected event. ([`../Src/Queue.lua#L534`](../Src/Queue.lua#L534))
  ...
  - `IsActive` ([`../Src/Queue.lua#L347`](../Src/Queue.lua#L347))
  - `ClearPendingAck` ([`../Src/Queue.lua#L353`](../Src/Queue.lua#L353))
  - `Enqueue` ([`../Src/Queue.lua#L364`](../Src/Queue.lua#L364))
  - `Flush` ([`../Src/Queue.lua#L376`](../Src/Queue.lua#L376))
  - `RequiresHardwareEvent` ([`../Src/Queue.lua#L399`](../Src/Queue.lua#L399))
  - `SendNext` ([`../Src/Queue.lua#L404`](../Src/Queue.lua#L404))
  - `BeginEntry` ([`../Src/Queue.lua#L440`](../Src/Queue.lua#L440))
  - `HandleAck` ([`../Src/Queue.lua#L477`](../Src/Queue.lua#L477))
  - `AssumeAck` ([`../Src/Queue.lua#L486`](../Src/Queue.lua#L486))
  - `RawSend` ([`../Src/Queue.lua#L496`](../Src/Queue.lua#L496))
  - `Complete` ([`../Src/Queue.lua#L517`](../Src/Queue.lua#L517))
  - `OnChatEvent` ([`../Src/Queue.lua#L544`](../Src/Queue.lua#L544))
  - `OnOpenChat` ([`../Src/Queue.lua#L613`](../Src/Queue.lua#L613))
  - `TryContinue` ([`../Src/Queue.lua#L623`](../Src/Queue.lua#L623))
  - `ResetStallTimer` ([`../Src/Queue.lua#L642`](../Src/Queue.lua#L642))
  - `CancelStallTimer` ([`../Src/Queue.lua#L659`](../Src/Queue.lua#L659))
  - `OnStallTimeout` ([`../Src/Queue.lua#L666`](../Src/Queue.lua#L666))
  - `CreateContinueFrame` ([`../Src/Queue.lua#L686`](../Src/Queue.lua#L686))
  - `ShowContinuePrompt` ([`../Src/Queue.lua#L746`](../Src/Queue.lua#L746))
  - `HideContinuePrompt` ([`../Src/Queue.lua#L783`](../Src/Queue.lua#L783))
  - `EnableEscapeCancel` ([`../Src/Queue.lua#L794`](../Src/Queue.lua#L794))
  - `DisableEscapeCancel` ([`../Src/Queue.lua#L827`](../Src/Queue.lua#L827))
  - `Cancel` ([`../Src/Queue.lua#L834`](../Src/Queue.lua#L834))
- Events registered:
...
- Methods:
  ...
  - `Chat:OnSend(text, chatType, language, target) → boolean` ([`../Src/Chat.lua#L222`](../Src/Chat.lua#L222))
  - `Chat:DirectSend(msg, chatType, language, target) → nil` ([`../Src/Chat.lua#L237`](../Src/Chat.lua#L237))
- Invariants:
