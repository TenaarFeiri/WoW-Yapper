...
- Methods:
  - `CompareVersions` — Compares semantic version strings. ([`../Src/Interface/Window.lua#L295`](../Src/Interface/Window.lua#L295))
  - `GetSortedVersions` — Returns WHATS_NEW entries sorted by version. ([`../Src/Interface/Window.lua#L306`](../Src/Interface/Window.lua#L306))
  - `CheckForChangelogUpdate` — Handshake that updates seen records and triggers popups. ([`../Src/Interface/Window.lua#L382`](../Src/Interface/Window.lua#L382))
  - `PopulateWhatsNewContent` — Renders changelog notes into a container. ([`../Src/Interface/Window.lua#L818`](../Src/Interface/Window.lua#L818))
  - `RefreshWhatsNewContent` — Wipes and re-renders the WhatsNew popup. ([`../Src/Interface/Window.lua#L866`](../Src/Interface/Window.lua#L866))
  - `UpdateWhatsNewButtonScale` — Scales the 'Got it' button text. ([`../Src/Interface/Window.lua#L883`](../Src/Interface/Window.lua#L883))
  - [NEW] `Interface:GetWelcomeVersion() → number`: Returns the target version of the welcome screen content. ([`../Src/Interface/Window.lua#L317`](../Src/Interface/Window.lua#L317))
  ...
  - `ShouldShowWelcomeChoice` ([`../Src/Interface/Window.lua#L361`](`../Src/Interface/Window.lua#L361`))
  - `ShouldShowWhatsNew` ([`../Src/Interface/Window.lua#L373`](`../Src/Interface/Window.lua#L373`))
  - `MarkWelcomeShown` ([`../Src/Interface/Window.lua#L408`](`../Src/Interface/Window.lua#L408`))
  - `MarkVersionSeen` ([`../Src/Interface/Window.lua#L412`](`../Src/Interface/Window.lua#L412`))
  - `CreateWelcomeChoiceFrame` ([`../Src/Interface/Window.lua#L467`](`../Src/Interface/Window.lua#L467`))
  - `CreateWhatsNewFrame` ([`../Src/Interface/Window.lua#L661`](`../Src/Interface/Window.lua#L661`))
  - `CreateMainWindow` ([`../Src/Interface/Window.lua#L901`](`../Src/Interface/Window.lua#L901`))
  - `UpdateSidebarSelection` ([`../Src/Interface/Window.lua#L1086`](`../Src/Interface/Window.lua#L1086`))
  - `GetUIFontOffset` ([`../Src/Interface/Window.lua#L1105`](`../Src/Interface/Window.lua#L1105`))
  - `SetUIFontOffset` ([`../Src/Interface/Window.lua#L1111`](`../Src/Interface/Window.lua#L1111`))
  - `ScaledRow` ([`../Src/Interface/Window.lua#L1119`](`../Src/Interface/Window.lua#L1119`))
  - `ApplyUIFontScale` ([`../Src/Interface/Window.lua#L1125`](`../Src/Interface/Window.lua#L1125`))
  - `RefreshFontScaleLabel` ([`../Src/Interface/Window.lua#L1153`](`../Src/Interface/Window.lua#L1153`))
