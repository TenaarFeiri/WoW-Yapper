...
local SETTING_TOOLTIPS              = {
    ...
    ["Spellcheck.YASFreqCap"] = "Maximum number of unique vocabulary words YAS tracks. Older and less-used words are pruned first when this cap is hit.",
...
local FRIENDLY_LABELS               = {
    ...
    ["Spellcheck.YASFreqCap"] = "Vocabulary cap",
