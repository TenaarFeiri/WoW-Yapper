...
local CODE = {
    ...
    MISSING_UTILS                  = "YapperTable.Utils is critical and missing.",
    MISSING_MIGRATIONS             = "YapperTable.Migrations is critical and missing.",
    MISSING_CONFIG                 = "YapperTable.Config is critical and missing.",
    MISSING_EVENTS                 = "YapperTable.Events is critical and missing.",
    MISSING_FRAMES                 = "YapperTable.Frames is critical and missing.",
    MISSING_EVENTFRAMES            = "YapperTable.EventFrames is critical and missing.",
    MISSING_API                    = "YapperTable.API is critical and missing.",
    MISSING_STATE                  = "YapperTable.State is critical and missing.",
    MISSING_SPELLCHECK             = "YapperTable.Spellcheck is critical and missing.",
    MISSING_ICONGALLERY            = "YapperTable.IconGallery is critical and missing.",
    MISSING_EDITBOX                = "YapperTable.EditBox is critical and missing.",
    MISSING_EDITBOXHOOKSCORE       = "YapperTable.EditBoxHooksCore is critical and missing.",
    MISSING_ROUTER                 = "YapperTable.Router is critical and missing.",
    MISSING_CHUNKING               = "YapperTable.Chunking is critical and missing.",
    MISSING_QUEUE                  = "YapperTable.Queue is critical and missing.",
    MISSING_CHAT                   = "YapperTable.Chat is critical and missing.",
    MISSING_MULTILINE              = "YapperTable.Multiline is critical and missing.",
    MISSING_AUTOCOMPLETE           = "YapperTable.Autocomplete is critical and missing.",
    MISSING_EMOTES                 = "YapperTable.Emotes is critical and missing.",
    MISSING_HISTORY                = "YapperTable.History is critical and missing.",
    MISSING_THEME                  = "YapperTable.Theme is critical and missing.",
    MISSING_INTERFACE              = "YapperTable.Interface (PurgeRenderCache) is critical and missing.",
